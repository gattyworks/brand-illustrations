...
```text
[Subject/Action]: A clean, modern vector-style illustration of [Character 1 Name] ([Character 1 Visual Description]) and [Character 2 Name] ([Character 2 Visual Description]), doing [Action/Interaction with Metaphor Object]. 
[Composition]: Centered composition, ample negative space. 
[Style Constraints]: Flat colors, bold clean lines, [Brand Style Vibe], [Background description, e.g., solid light background]. 
...
```text
[Subject/Action]: A clean, modern vector-style illustration of [Character Name] ([Character Visual Description]), doing [Action/Interaction with Metaphor Object]. 
[Composition]: Rule of thirds composition, character positioned on the right side, leaving the left side empty for typography. 
[Style Constraints]: Flat colors, bold clean lines, [Brand Style Vibe], [Background description]. 
...
4. **Enforce Style**: Always inject the constraints defined in `brand/style-dna.md`.
